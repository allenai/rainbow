    ...
    RAINBOW_DATASETS = {
        ...
        "winogrande": RainbowDataset(
            ...
            splits={
                ...
                "train_xs": RainbowSplit(
                    name="train_xs",
                    size=160,
                    features_path="winogrande_1.1/train_xs.jsonl",
                    labels_path="winogrande_1.1/train_xs-labels.lst",
                ),
                "train_s": RainbowSplit(
                    name="train_s",
                    size=640,
                    features_path="winogrande_1.1/train_s.jsonl",
                    labels_path="winogrande_1.1/train_s-labels.lst",
                ),
                "train_m": RainbowSplit(
                    name="train_m",
                    size=2558,
                    features_path="winogrande_1.1/train_m.jsonl",
                    labels_path="winogrande_1.1/train_m-labels.lst",
                ),
                "train_l": RainbowSplit(
                    name="train_l",
                    size=10234,
                    features_path="winogrande_1.1/train_l.jsonl",
                    labels_path="winogrande_1.1/train_l-labels.lst",
                ),
                "train_xl": RainbowSplit(
                    name="train_xl",
                    size=40398,
                    features_path="winogrande_1.1/train_xl.jsonl",
                    labels_path="winogrande_1.1/train_xl-labels.lst",
